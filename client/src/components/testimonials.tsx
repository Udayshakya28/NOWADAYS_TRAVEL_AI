    ...
    <section className="py-16 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">Trusted by Teams & Groups Everywhere</h2>
          <p className="text-slate-600">See what our customers say about Nowadays Travel AI</p>
        </div>
