...
export default function DestinationShowcase() {
  ...
  const getCategoryColor = (category: string) => {
    const colors = {
      ...
      'Friends Favorite': 'bg-pink-100 text-pink-800',
      'Beach & Culture': 'bg-yellow-100 text-yellow-800',
      'Tropical Escape': 'bg-teal-100 text-teal-800',
    };
    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-slate-900 mb-4">Popular Group Travel Destinations</h2>
          <p className="text-slate-600">Discover amazing destinations for business trips, friend groups, and everything in between</p>
        </div>
